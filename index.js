...
function displaymovie(data) {
  ...
  for (let i = 0; i < data.length; i++) {
    ...
    <div class="movie">
        <div class="overlay">
            <div class="video">
             <iframe width="200" height="200" src="${data[i].video}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            </div>
            <div class="details">
                <h1>${data[i].name}</h1>
                <h2>⭐${data[i].rating}</h2>
